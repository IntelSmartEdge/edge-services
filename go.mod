...
module github.com/smart-edge-open/edge-services

go 1.16

require (
	github.com/smart-edge-open/edge-services/common/log v0.0.0-00010101000000-000000000000
...
replace github.com/smart-edge-open/edge-services/common/log => ./common/log
